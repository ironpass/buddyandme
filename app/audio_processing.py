...
def compress_to_mp3(pcm_data, sample_rate=32000, num_channels=1, bitrate='32k', trim_silence=True):
    """
    ...
    audio.export(mp3_io, format="mp3", bitrate=bitrate, codec='libmp3lame', parameters=["-q:a", "7"])
